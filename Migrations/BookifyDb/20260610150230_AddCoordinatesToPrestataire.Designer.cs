...
namespace Bookify_API.Migrations.BookifyDb
{
    ...
    [Migration("20260610150230_AddCoordinatesToPrestataire")]
    partial class AddCoordinatesToPrestataire
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bookify_API.Models.Avis", b =>
                {
                    ...
                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("IdAvis"));
                    ...
                    b.HasIndex(new[] { "IdPrestataire" }, "idPrestataire_avis");

                    b.HasIndex(new[] { "IdRendezVous" }, "idRendezVous_avis");

                    b.HasIndex(new[] { "IdUtilisateur" }, "idUtilisateur_avis");
